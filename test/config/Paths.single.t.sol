...
contract SingleSwapPaths {
    uint256 internal tokenPairCount;
    mapping(uint256 => Types.TokenPair) internal tokenPairs;
    ...
    constructor() {
        ...
        Types.TokenPair storage newTokenPair = tokenPairs[tokenPairCount++];
        ...
        newTokenPair = tokenPairs[tokenPairCount++];
